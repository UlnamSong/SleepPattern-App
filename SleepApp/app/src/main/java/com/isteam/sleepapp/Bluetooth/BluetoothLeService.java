...
package com.isteam.sleepapp.Bluetooth;
...
public class BluetoothLeService extends Service {
    ...
    public final static String EXTRA_BYTESDATA =
            "com.example.bluetooth.le.EXTRA_BYTESDATA";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            Log.d(TAG, "onCharacteristicChanged: Notification Occured.");
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
        }
    ...
    private void broadcastUpdate(final String action,
        ...
        final Intent intent = new Intent(action);
        Log.d(TAG, "broadcastUpdate: Start");
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0) {
                ...
                intent.putExtra(EXTRA_BYTESDATA,  data);

                Log.d(TAG, Thread.currentThread().getStackTrace()[2].getMethodName() + "stringbuilder : " + stringBuilder.toString() );
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        //byteArrayToHex(data);
        Log.d(TAG, Thread.currentThread().getStackTrace()[2].getMethodName() + " + data : " + byteArrayToHex(data));
